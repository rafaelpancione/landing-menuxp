        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="font-body text-lg lg:text-xl mb-8 opacity-90">
              Pare de pagar taxas abusivas, padronize seu atendimento e aumente 
              sua receita com uma plataforma que realmente trabalha para você. 
              Descubra como a MenuXP pode transformar seu negócio.
            </p>
