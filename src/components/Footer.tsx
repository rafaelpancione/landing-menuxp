...
import logo from '../images/menuxp-logo.svg';
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="font-body text-gray-300 max-w-md">
              A plataforma completa para restaurantes que querem controle total 
              das vendas: sem taxas, com IA e gamificação para crescer de verdade.
            </p>
          </div>
