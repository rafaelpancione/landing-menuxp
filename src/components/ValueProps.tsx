...
import PedidoSemLogin from '../images/sem-login.svg'
import Whitelabel from '../images/whitelabel.svg';
import MultiIdiomas from '../images/mult-idiomas.svg';
import Gestao from '../images/gestao.svg';
import Minijogos from '../images/games.svg';
import IAGamificacao from '../images/ia.svg';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-body text-lg text-gray-600 max-w-3xl mx-auto">
            Uma plataforma única para cardápio digital, gestão de pedidos e crescimento 
            com dados.
          </p>
        </motion.div>
