...
import { Gamepad2, Target, TrendingUp, Gift } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="font-body text-lg text-gray-600 mb-8">
              Transforme a espera em diversão! Seus clientes jogam enquanto aguardam 
              o pedido e ganham cupons para a próxima compra. Uma estratégia divertida 
              para aumentar fidelização e ticket médio.
            </p>
          ...
          >
            <div className="brut-card p-8 bg-white">
              <div className="text-center mb-6">
                ...
                <h4 className="font-title text-xl font-regular text-black mb-2">
                  Exemplo de Cupom via Jogo
                </h4>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-black">
                  ...
                  <span className="brut-badge bg-[var(--mx-yellow)] text-black">
                    20% OFF
                  </span>
                </div>
                ...
                <div className="p-4 bg-blue-50 rounded-lg border border-black">
                  <p className="text-sm text-gray-700">
                    <strong>Como funciona:</strong> Cliente atinge 1000 pontos no mini-jogo 
                    e recebe um código único para usar no próximo pedido.
                  </p>
                </div>
