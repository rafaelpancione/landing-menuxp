        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="font-body text-lg text-gray-600 mb-8">
              Acompanhe em tempo real as métricas que realmente importam: ticket médio, 
              desempenho dos pratos, tempo de preparo e impacto das campanhas e cupons. 
            ...
            <div className="brut-card p-8 bg-white">
              ...
              <div className="mt-8 p-4 bg-green-50 rounded-lg border border-green-200">
                <p className="text-sm text-green-700 text-center">
                  <strong>💡 Insight:</strong> Campanhas com gamificação geraram 
                  43% mais engajamento que promoções tradicionais.
                </p>
              </div>
            </div>
          </motion.div>
