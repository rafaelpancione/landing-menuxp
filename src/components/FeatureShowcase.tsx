  ...
  const campaignsContent = (
    <div className="space-y-4">
      <div className="brut-card p-4">
        ...
        <p className="text-sm text-gray-600 mb-2">Meta: +15% de receita. Orçamento sugerido: R$ 200 em tráfego local.</p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="font-body text-lg text-gray-600 mb-8">
              ...
              personalizadas. Criamos missões de marketing gamificadas que impulsionam 
              vendas de forma estratégica e divertida.
            </p>
