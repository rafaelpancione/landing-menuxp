...
const FAQ: React.FC = () => {
  const faqItems = [
    ...
    },
    {
      ...
      content: (
        <div className="pt-3 sm:pt-4 leading-relaxed">
          Não. O cliente só informa nome e WhatsApp no checkout.
        </div>
      )
    },
    {
      ...
      content: (
        <div className="pt-3 sm:pt-4 leading-relaxed">
          Sim. O app é multi-idiomas e também geramos cardápios para impressão em outros
          idiomas com QR Code.
        </div>
      )
    },
    {
      ...
      content: (
        <div className="pt-3 sm:pt-4 leading-relaxed">
          Não, mas recomendamos. Eles aumentam o engajamento e podem liberar cupons com metas
          definidas por você.
        </div>
      )
    },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="font-body text-lg text-gray-600">
            Esclarecemos as principais dúvidas sobre a MenuXP
          </p>
        </motion.div>
