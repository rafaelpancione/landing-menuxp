...
import { ShieldCheck, QrCode, Languages, PhoneCall, ArrowRight, Eye } from 'lucide-react';
import template01 from '../images/01.png'
import template02 from '../images/02.png'
import template03 from '../images/03.png'
import template04 from '../images/04.png'
...
const Hero: React.FC = () => {
 ...
 const prefersReduced = useReducedMotion();
  ...
  const mockups = [
  { alt: 'Template Clássico', src: template01 },
  { alt: 'Template Dark', src: template02 },
  { alt: 'Template Clean', src: template03 },
  { alt: 'Template Brutalista', src: template04 }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="font-body text-lg text-gray-700 mb-8 max-w-lg">
              O MenuXP coloca o seu restaurante no controle: pedidos via QR Code ou URL, 
              gestão facilidada, multi-idiomas, cardápio para impressão e mini-jogos com cupons 
              para reter clientes.
            </p>
